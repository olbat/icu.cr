...
lib LibICU
  ...
  fun uset_complement_all_code_points = uset_complementAllCodePoints{{SYMS_SUFFIX.id}}(set : USet, str : UChar*, length : Int32T)
  fun uset_complement_range = uset_complementRange{{SYMS_SUFFIX.id}}(set : USet, start : UChar32, _end : UChar32)
  fun uset_complement_string = uset_complementString{{SYMS_SUFFIX.id}}(set : USet, str : UChar*, length : Int32T)
  ...
  fun uset_get_range_count = uset_getRangeCount{{SYMS_SUFFIX.id}}(set : USet) : Int32T
  ...
  fun uset_has_strings = uset_hasStrings{{SYMS_SUFFIX.id}}(set : USet) : UBool
  ...
  fun uset_remove_all_code_points = uset_removeAllCodePoints{{SYMS_SUFFIX.id}}(set : USet, str : UChar*, length : Int32T)
  ...
  fun uset_retain_all_code_points = uset_retainAllCodePoints{{SYMS_SUFFIX.id}}(set : USet, str : UChar*, length : Int32T)
  fun uset_retain_string = uset_retainString{{SYMS_SUFFIX.id}}(set : USet, str : UChar*, length : Int32T)
