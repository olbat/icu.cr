...
lib LibICU
  ...
  fun uidna_label_to_ascii_utf8 = uidna_labelToASCII_UTF8{{SYMS_SUFFIX.id}}(idna : Uidna, label : LibC::Char*, length : Int32T, dest : LibC::Char*, capacity : Int32T, p_info : UidnaInfo*, p_error_code : UErrorCode*) : Int32T
  ...
  fun uidna_label_to_unicode_utf8 = uidna_labelToUnicodeUTF8{{SYMS_SUFFIX.id}}(idna : Uidna, label : LibC::Char*, length : Int32T, dest : LibC::Char*, capacity : Int32T, p_info : UidnaInfo*, p_error_code : UErrorCode*) : Int32T
  ...
  fun uidna_name_to_ascii_utf8 = uidna_nameToASCII_UTF8{{SYMS_SUFFIX.id}}(idna : Uidna, name : LibC::Char*, length : Int32T, dest : LibC::Char*, capacity : Int32T, p_info : UidnaInfo*, p_error_code : UErrorCode*) : Int32T
  ...
  fun uidna_name_to_unicode_utf8 = uidna_nameToUnicodeUTF8{{SYMS_SUFFIX.id}}(idna : Uidna, name : LibC::Char*, length : Int32T, dest : LibC::Char*, capacity : Int32T, p_info : UidnaInfo*, p_error_code : UErrorCode*) : Int32T
  fun uidna_open_uts46 = uidna_openUTS46{{SYMS_SUFFIX.id}}(options : Uint32T, p_error_code : UErrorCode*) : Uidna
