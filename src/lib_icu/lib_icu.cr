...
lib LibICU
  ...
  fun u_get_time_zone_files_directory = u_getTimeZoneFilesDirectory{{SYMS_SUFFIX.id}}(status : UErrorCode*) : LibC::Char*
  ...
  fun u_set_time_zone_files_directory = u_setTimeZoneFilesDirectory{{SYMS_SUFFIX.id}}(path : LibC::Char*, status : UErrorCode*)
